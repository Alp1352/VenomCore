package com.venom.venomcore.nms.v1_9_R1.hologram.armorstand;

import com.venom.venomcore.nms.v1_9_R1.NMSUtils;
...
public class CustomArmorStand extends EntityArmorStand implements HologramArmorStand {
    ...
    @Override
    public boolean c(int i, net.minecraft.server.v1_9_R1.ItemStack itemstack) {
        // Prevent equipping the armor stand.
        return false;
    }

    @Override
    public EnumInteractionResult a(EntityHuman entityhuman, Vec3D vec3d, net.minecraft.server.v1_9_R1.ItemStack itemStack, EnumHand enumHand) {
