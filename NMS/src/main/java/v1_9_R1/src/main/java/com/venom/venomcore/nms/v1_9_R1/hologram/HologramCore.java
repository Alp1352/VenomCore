package com.venom.venomcore.nms.v1_9_R1.hologram;


import com.venom.venomcore.nms.core.hologram.Hologram;
import com.venom.venomcore.nms.v1_9_R1.hologram.armorstand.CustomArmorStand;
...
public class HologramCore implements com.venom.venomcore.nms.core.hologram.HologramCore {
    ...
    @Override
    public com.venom.venomcore.nms.core.hologram.Hologram createHologram(JavaPlugin plugin, Location location, String... text) {
        return new com.venom.venomcore.nms.v1_9_R1.hologram.Hologram(plugin, location, Arrays.asList(text));
    }
