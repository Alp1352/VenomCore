package com.venom.nms.v1_8_R2.NBT;


import com.venom.nms.core.NBT.NBTList;
...
public class NBTCompound implements com.venom.nms.core.NBT.NBTCompound {
    ...
    public NBTCompound set(String tag, NBTList list) {
        master.set(tag, ((com.venom.nms.v1_8_R2.NBT.NBTList) list).getList());
        return this;
    }
