...
public class HologramCore implements com.venom.nms.core.Hologram.HologramCore {
    ...
    @Override
    public com.venom.nms.core.Hologram.Hologram createHologram(JavaPlugin plugin, Location location, String... text) {
        return new com.venom.nms.v1_8_R3.Hologram.Hologram(plugin, location, Arrays.asList(text));
    }
