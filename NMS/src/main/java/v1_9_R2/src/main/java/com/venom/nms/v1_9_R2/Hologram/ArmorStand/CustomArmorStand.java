package com.venom.nms.v1_9_R2.Hologram.ArmorStand;
...
public class CustomArmorStand extends EntityArmorStand implements HologramArmorStand {
    ...
    @Override
    public boolean c(int i, net.minecraft.server.v1_9_R2.ItemStack itemstack) {
        // Prevent equipping the armor stand.
        return false;
    }

    @Override
    public EnumInteractionResult a(EntityHuman entityhuman, Vec3D vec3d, net.minecraft.server.v1_9_R2.ItemStack itemStack, EnumHand enumHand) {
