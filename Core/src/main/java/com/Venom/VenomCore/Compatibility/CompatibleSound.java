...
/**
 * <b>CompatibleSound</b> - Universal Minecraft Sound Support<br>
...
public enum CompatibleSound {
    ...
    /**
     * Cached list of {@link CompatibleSound#values()} to avoid allocating memory for
     * calling the method every time.
     *
     * @since 2.0.0
     */
    public static final CompatibleSound[] VALUES = values();

    @Nullable
    private final Sound sound;

    CompatibleSound(@Nonnull String... legacies) {
    ...
    /**
     * Parses the CompatibleSound with the given name.
     *
     * @param sound the name of the sound.
     * @return a matched CompatibleSound.
     * @since 1.0.0
     */
    @Nonnull
    public static Optional<CompatibleSound> matchCompatibleSound(@Nonnull String sound) {
        Validate.notEmpty(sound, "Cannot match CompatibleSound of a null or empty sound name");
        return Optional.ofNullable(Data.NAMES.get(format(sound)));
    }

    /**
     * Parses the CompatibleSound with the given bukkit sound.
     *
     ...
     */
    @Nonnull
    public static CompatibleSound matchCompatibleSound(@Nonnull Sound sound) {
        Objects.requireNonNull(sound, "Cannot match CompatibleSound of a null sound");
     ...
     * <blockquote><pre>
     *     Record record = CompatibleSound.parse(player, location, sound, false).join();
     *     // Loop:
    ...
    public static CompletableFuture<Record> parse(@Nullable Player player, @Nonnull Location location, @Nullable String sound, boolean play) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            Optional<CompatibleSound> typeOpt = matchCompatibleSound(name);
    ...
    public static CompletableFuture<Void> stopMusic(@Nonnull Player player) {
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            CompatibleSound[] musics = {MUSIC_CREATIVE, MUSIC_CREDITS,
            ...
            for (CompatibleSound music : musics) {
    ...
    /**
     * Parses the CompatibleSound as a {@link Sound} based on the server version.
     *
    ...
    private static final class Data {
         ...
         * @since 3.1.0
         */
        private static final Map<String, CompatibleSound> NAMES = new HashMap<>();
